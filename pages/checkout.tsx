...
import PaymentMethodSelector from "../components/Checkouts/PaymentMethodSelector";
import StripeCheckoutElement from "../components/Checkouts/StripeCheckoutElement";

// let w = window.innerWidth;
export type PaymentType = "CASH_ON_DELIVERY" | "BANK_TRANSFER" | "STRIPE";
              ...
              <div className="border border-gray500 p-6 divide-y-2 divide-gray200">
                ...
                <div>
                  ...
                  <div className="grid gap-4 mt-2 mb-4">
                    <PaymentMethodSelector defaultValue="CASH_ON_DELIVERY" paymentMethod={paymentMethod} setPaymentMethod={setPaymentMethod} key="CASH_ON_DELIVERY" />
                    <PaymentMethodSelector defaultValue="BANK_TRANSFER" paymentMethod={paymentMethod} setPaymentMethod={setPaymentMethod} key="BANK_TRANSFER" />
                    <PaymentMethodSelector defaultValue="STRIPE" paymentMethod={paymentMethod} setPaymentMethod={setPaymentMethod} key="STRIPE" />
                  </div>

                  {paymentMethod === 'STRIPE' && <div>
                    <StripeCheckoutElement amount={10} currency="usd" />
                  </div>}

                  {paymentMethod !== 'STRIPE' && <div className="my-8">
                    <div className="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                      <input
                        type="checkbox"
